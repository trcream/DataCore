            ...
            <div className="bg-[url('/assets/img_placeholder/th-4/hero-bg.jpg')] bg-cover bg-no-repeat pb-20 pt-28 md:pb-[265px] md:pt-40 lg:pt-44 xl:pt-[224px]">
              ...
              <div className="global-container">
                <h1 className="jos mb-6 font-spaceGrotesk leading-none -tracking-[3px] text-white">
                  Next-Gen Blockchain and Crypto Solutions
                </h1>
                <div className="mx-auto max-w-[1090px]">
                  <p className="leading-[1.33] lg:text-xl xl:text-2xl">
                    Our cutting-edge tools empower you to excel in the rapidly
                    evolving digital economy. From high-speed NFT sniping bots
                    to automated wallet generation and quantitative trading
                    strategies, DataCore Labs is your partner in blockchain
                    innovation.
                  </p>
                </div>
                <form
                ...
                <div className="jos" data-jos_animation="fade-right">
                  ...
                  <div>
                    <p className="mb-8 text-lg leading-[1.42] last:mb-0 lg:text-[21px]">
                      Individual traders and crypto enthusiasts trust our custom
                      bot creation services to automate their trading
                      strategies, manage digital assets, and optimize their
                      blockchain activities with ease.
                    </p>
                    <p className="mb-8 text-lg leading-[1.42] last:mb-0 lg:text-[21px]">
                      Our platform empowers everyday users to build tailored
                      bots that cater to their specific needs, whether it's for
                      NFT sniping, automated trading, or secure wallet
                      management. At DataCore Labs, we make powerful, real-time
                      solutions accessible to everyone, helping you achieve your
                      goals in the fast-paced world of blockchain and crypto.
                    </p>
                    <Link
                      rel="noopener noreferrer"
