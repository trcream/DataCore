              ...
              >
                ...
                <div className='text-lg leading-[1.4] lg:text-[21px]'>
                  <p className='mb-7 last:mb-0'>
                    ...
                    forefront of harnessing the power of artificial intelligence
                    (AI) to drive innovation and transform our business
                    landscape.
                  </p>
                  <p className='mb-7 last:mb-0'>
                    With a background in AI tech expert, he is leads our AI
                    strategy, overseeing the development and implementation of
                    cutting-edge AI and also machine learning initiatives. With
                    a passion for technology and a track record of successful AI
                    projects in our companys journey.
                  </p>
            ...
            <div>
              ...
              <ul className='grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3'>
                ...
                >
                  ...
                  <p>
                    He assess emerging AI technologies, tools, and platforms to
                    determine which ones are suitable for the organization.
                  </p>
                </li>
                {/* Team Member Skill Item */}
                {/* Team Member Skill Item */}
